...
const DEFAULT_SNIPPETS_URLS = [
    "https://www.mozilla.org/firefox/features/?utm_source=snippet&utm_medium=snippet&utm_campaign=default+feature+snippet", "https://addons.mozilla.org/firefox/?utm_source=snippet&utm_medium=snippet&utm_campaign=addons"
];
...
window.addEventListener("pageshow", function() {
    ...
    window.gObserver.observe(document.documentElement, {
        attributes: true
    });
    fitToWidth();
...
function onSearchSubmit(aEvent) {
    ...
    if (searchURL && searchTerms.length > 0) {
        ...
        let event = new CustomEvent("AboutHomeSearchEvent", {
            detail: engineName
        });
